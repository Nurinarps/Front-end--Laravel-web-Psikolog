...
<div class="row justify-content-center ">
    <div style="display: flex; align-items: center; background: linear-gradient(to right, #BE85C5, #FFFFFF); padding: 60px;">
        ...
        <div class="col-lg-6 p-4">
            <h1> Konsultasi Bersama Mentor Terbaikmu </h1>
            <p class="fs-5">Apakah Anda Merasakan Kecemasan, Overthinking, atau Kesulitan dalam Mengelola Emosi? Konsultasikan Masalah Anda dengan Tes Psikologi Spandiv!</p>
...
<div class="row justify-content-center" >
    <div style="display: flex; align-items: center; background: linear-gradient(to bottom, #BE85C5, #FFFFFF); padding: 100px; margin: 40px auto 0 auto;">
        <div class="col-lg-6 p-4" >
            <h1> Konsultasi dengan mentor itu dilakukan itu ngapaian aja ya? </h1>
            <p class="fs-5 card-text" >
                <ul>
                    <li><strong>Anda dapat berbicara dengan Mentor Terbaikmu.</strong></li>
                    <li><strong>Temukan solusi atas permasalahan yang Anda hadapi sekarang.</strong></li>
                    <li><strong>Temukan solusi dengan worksheet  untuk memecahkan masalah Anda</strong></li>
                    <li><strong>Kenali  dirimu  lebih lagi dengan tes psikologi.</strong></li>
                </ul>
            </p>
        </div>
